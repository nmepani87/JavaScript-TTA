...
window.alert('Hello there') //window alert to great user

var Sent1 = "This is the beginning of the string", Sent2 = " and this is the end of the string"; //Two variables given strings to be concatenated
